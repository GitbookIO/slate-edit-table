...
function schemaPlugin(optionsParam: Options | OptionsFormat): Object {
    ...
    return {
        ...
        changes: {
            ...
            insertRow: bindAndScopeChange(insertRow),
            removeRow: bindAndScopeChange(removeRow),
            insertColumn: bindAndScopeChange(insertColumn),
            removeColumn: bindAndScopeChange(removeColumn),
            removeTable: bindAndScopeChange(removeTable),
            moveSelection: bindAndScopeChange(moveSelection),
            moveSelectionBy: bindAndScopeChange(moveSelectionBy),
            setColumnAlign: bindAndScopeChange(setColumnAlign)
        }
    };
}
